<script lang="ts">
	...
	import { CaptionOutline } from 'flowbite-svelte-icons';
...
{#if videos}
	<div class="mx-auto grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4" transition:fade>
		{#each videos as video}
			<div transition:fade>
                <Card class="flex flex-col h-full">
                    ...
                    />
                    <div class="flex-grow">
                        <h5 class="mb-2 truncate text-lg font-bold tracking-tight text-gray-900 dark:text-white">
                            {video.title}
                        </h5>
